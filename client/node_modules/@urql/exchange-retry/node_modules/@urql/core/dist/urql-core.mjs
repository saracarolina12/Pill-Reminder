...
import { toPromise as l, take as h, filter as y, subscribe as k, map as m, tap as x, merge as E, mergeMap as g, takeUntil as w, make as O, onPush as N, share as b, fromPromise as _, fromValue as q, makeSubject as D, lazy as S, onStart as P, switchMap as V, publish as R, takeWhile as A, onEnd as M } from "wonka";
...
var fetchExchange = ({forward: e, dispatchDebug: r}) => t => {
  var n = g((e => {
    ...
    var s = w(y((r => "teardown" === r.kind && r.key === e.key))(t))(d(e, o, i));
    if ("production" !== process.env.NODE_ENV) {
      return N((t => {
...
var C = function Client(e) {
  ...
  var makeResultSource = r => {
    var i = w(y((e => "teardown" === e.kind && e.key === r.key))(s.source))(y((e => e.operation.kind === r.kind && e.operation.key === r.key && (!e.operation.context._instance || e.operation.context._instance === r.context._instance)))(O));
    if (e.maskTypename) {
      i = m((e => ({
        ...e,
